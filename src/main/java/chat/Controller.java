...
public class Controller {
    ...
    public long createUser(String nickname) throws SQLException {
        ...
        try {
            ...
            pstm.executeUpdate();
            long id = this.getAutogeneratedId(pstm);
            pstm.close();
            return id;
    ...
    public int deleteMessages (String nickname, long chatRoompk) throws SQLException {
       ...
       try {
           String consulta = "DELETE FROM messages " +
                   "WHERE createdBy = (SELECT users.id FROM users WHERE username = ?)" +
                   "AND messages.chatRoom = ?";
           PreparedStatement pstm = conn.prepareStatement(consulta);
           pstm.setString(1,nickname);
           pstm.setLong(2,chatRoompk);
           int deletedM = pstm.executeUpdate(); //Devuelve el numero de datos afectados
           pstm.close();
           return deletedM;
       }catch (SQLException ERR){
